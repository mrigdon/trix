...
(function() {
  ...
  (function() {
      ...
      Trix.Level2InputController = (function(superClass) {
        ...
        Level2InputController.prototype.events = {
          ...
          paste: function(event) {
            ...
            if (pasteEventHasFilesOnly(event)) {
              ...
              if ((ref5 = this.responder) != null) {
                ref5.insertText(Trix.Text.textForStringWithAttributes(paste.string, {
                  href: paste.href
                }));
              }
              this.render();
        ...
        Level2InputController.prototype.inputTypes = {
          ...
          insertFromPaste: function() {
            var dataTransfer, href, html, name, paste, ref, ref1, ref2, ref3, ref4;
            ...
            if (href = dataTransfer.getData("URL")) {
              ...
              this.withTargetDOMRange(function() {
                var ref1;
                return (ref1 = this.responder) != null ? ref1.insertText(Trix.Text.textForStringWithAttributes(paste.string, {
                  href: paste.href
                })) : void 0;
              });
    ...
    (function() {
      var css, defer, escapeHTML, handleEvent, keyNames, lang, makeElement, ref, tagName,
        bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
        extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
        hasProp = {}.hasOwnProperty;

      defer = Trix.defer, escapeHTML = Trix.escapeHTML, handleEvent = Trix.handleEvent, makeElement = Trix.makeElement, tagName = Trix.tagName;
      ...
      Trix.AttachmentEditorController = (function(superClass) {
        ...
        AttachmentEditorController.prototype.addToolbar = undoable(function() {
          ...
          element.innerHTML = "<div class=\"trix-button-row\">\n  <span class=\"trix-button-group trix-button-group--actions\">\n    <button type=\"button\" data-trix-action=\"remove\" class=\"trix-button trix-button--remove\" title=\"" + lang.remove + "\">" + lang.remove + "</button>\n  </span>\n</div>";
          if (this.attachment.isPreviewable()) {
            name = escapeHTML(this.attachment.getFilename());
            size = escapeHTML(this.attachment.getFormattedFilesize());
            element.innerHTML += "<div class=\"" + css.attachmentMetadataContainer + "\">\n  <span class=\"" + css.attachmentMetadata + "\">\n    <span class=\"" + css.attachmentName + "\" title=\"" + name + "\">" + name + "</span>\n    <span class=\"" + css.attachmentSize + "\">" + size + "</span>\n  </span>\n</div>";
          }
          handleEvent("click", {
            onElement: element,
    ...
    (function() {
      ...
      Trix.BlockView = (function(superClass) {
        ...
        BlockView.prototype.createContainerElement = function(depth) {
          var attribute, options, size, tagName;
          attribute = this.attributes[depth];
          tagName = getBlockConfig(attribute).tagName;
          options = {
            tagName: tagName
          };
          if (attribute === "attachmentGallery") {
    ...
    (function() {
      ...
      Trix.HTMLSanitizer = (function(superClass) {
        var DEFAULT_ALLOWED_ATTRIBUTES, DEFAULT_FORBIDDEN_PROTOCOLS, createBodyElementForHTML, elementIsRemovable;
        ...
        function HTMLSanitizer(html, arg) {
          var ref;
          ref = arg != null ? arg : {}, this.allowedAttributes = ref.allowedAttributes, this.forbiddenProtocols = ref.forbiddenProtocols;
    ...
    (function() {
      ...
      Trix.HTMLParser = (function(superClass) {
        ...
        HTMLParser.prototype.appendBlockForTextNode = function(node) {
          ...
          if (element === this.currentBlockElement) {
            return;
          }
          if (!(element === this.containerElement || this.isBlockElement(element))) {
            return;
          }
      ...
      Trix.Composition = (function(superClass) {
        ...
        Composition.prototype.updateCurrentAttributes = function() {
          ...
          if (selectedRange = this.getSelectedRange({
            ...
            for (i = 0, len = ref.length; i < len; i++) {
              attributeName = ref[i];
              if (currentAttributes.code && attributeName !== 'code') {
    ...
    (function() {
      ...
      Trix.registerElement("trix-editor", (function() {
        var addAccessibilityRole, autofocus, configureContentEditable, cursorTargetStyles, disableObjectResizing, id, makeEditable, setDefaultParagraphSeparator;
        id = 0;
        ...
        return {
          ...
          rootNode: {
            get: function() {
              var ref;
              return (ref = this.getRootNode()) != null ? ref : this.ownerDocument;
            }
          },
          trixId: {
            get: function() {
          ...
          toolbarElement: {
            get: function() {
              ...
              if (this.hasAttribute("toolbar")) {
                return (ref = this.rootNode) != null ? ref.querySelector("#" + (this.getAttribute("toolbar"))) : void 0;
          ...
          inputElement: {
            get: function() {
              ...
              if (this.hasAttribute("input")) {
                return (ref = this.rootNode) != null ? ref.querySelector("#" + (this.getAttribute("input"))) : void 0;
              } else if (this.parentNode) {
